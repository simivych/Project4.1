 ...
 */
public class AlphaBetaNoHeuristics extends ExpertPolicy
{
    ...
    protected boolean heuristicsFromMetadata;
     ...
     */
    public static AlphaBetaNoHeuristics createAlphaBeta()
    {
     ...
     */
    public AlphaBetaNoHeuristics(final boolean allowTranspositionTable)
    {
        friendlyName = "Alpha-Beta";
        heuristicsFromMetadata = true;
     ...
     */
    public AlphaBetaNoHeuristics(final String heuristicsFilepath) throws FileNotFoundException, IOException
    {
        friendlyName = "Alpha-Beta";
     ...
     * @param heuristics
     */
    public AlphaBetaNoHeuristics(final Heuristics heuristics)
    {
        friendlyName = "Alpha-Beta";
...
//	}
     ...
     */
    public static AlphaBetaNoHeuristics fromLines(final String[] lines)
    {
        ...
        AlphaBetaNoHeuristics alphaBeta = null;

        if (heuristics != null)
            alphaBeta = new AlphaBetaNoHeuristics(heuristics);

        if (alphaBeta == null)
            alphaBeta = new AlphaBetaNoHeuristics();
