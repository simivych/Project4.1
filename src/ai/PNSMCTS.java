...
/**
 * PN-MCTS as described in the bachelors thesis: "Combining Monte-Carlo Tree Search withProof-Number Search" by E. Doe
 *
 * Only supports deterministic, alternating-move games.
 *
 * This code was adapted from the "ExampleUCT.java" and "PNS.java" codes for the Ludii game engine. Both the original
 * codes were written by Dennis Soemers but put together and adapted by Elliot Doe.
 *
 * @author Elliot Doe
 */
public class PNSMCTS extends AI {
    ...
    public static Move finalMoveSelection(final Node rootNode) {
        ...
        //System.out.println("Number of simulations for PN-MCTS: "+sims);
